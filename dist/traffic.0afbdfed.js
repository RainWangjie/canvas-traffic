...
if (_util.isBrowserOk == true) {
  ...
  var left_greenc = function left_greenc() {
    left_green = !left_green;
  };

  // 俩车距离确认
  var distance_check = function distance_check(c1, c2, axis) {
    if (axis == 'x') {
      var dist,
          dist = c2.x - c1.x;
      disty = c2.y - c1.y;
  ...
  var check_inter = function check_inter(c, inter, axis) {
    if (axis == 'x') {
      if (inter.height > 40) {
  ...
  var gen_dir = function gen_dir(c, inter) {
    if (c.dd == false) {
  ...
  var drive_cars = function drive_cars() {
  ...
  var drawinter = function drawinter() {
    this.x = 0;
    this.y = 0;
    this.width = 0;
    this.height = 0;
  ...
  var drawroad = function drawroad() {
    this.x = 0;
    this.y = 0;
    this.width = 0;
    this.height = 0;
...
//# sourceMappingURL=/traffic.0afbdfed.map